...
Yii::app()->clientScript->registerCssFile(Yii::app()->params['baseUrl'] . '/css/login_santander.css');
?>
<?php
...
<div class="cont-landing">
    ...
    <div class="paso2">
        ...
        <p class="p">
            ...
            <span class="userEjemplo"><?php echo $loginEjemplo; ?></span>            
        ...
        <p class="p" id="boxPass" style="display: none;">
            ...
            <span class="userEjemplo">Mínimo 5 caracteres</span>
