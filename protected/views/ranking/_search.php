...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'total_puntos'); ?>
		<?php echo $form->textField($model,'total_puntos'); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'total_plenos'); ?>
	...
	<div class="row">
		<?php echo $form->label($model,'amigos_usuario_id'); ?>
		<?php echo $form->textArea($model,'amigos_usuario_id',array('rows'=>6, 'cols'=>50)); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'tipo_estado_usuario_id'); ?>
