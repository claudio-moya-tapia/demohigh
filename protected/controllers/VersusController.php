...
class VersusController extends Controller {
    ...
    public function actionAjaxList() {
        if (!Yii::app()->user->isGuest) {
            ...
            $criteria->select = 'versus_id, fecha, pais_id_a, pais_id_b, goles_a, goles_b, ganador, canplay';            
            
            header('Content-type: text/json');
            header('Content-type: application/json');
            echo CJSON::encode(Versus::model()->findAll($criteria));            
        }
    }
    ...
    public function actionCreate() {
        ...
        if (isset($_POST['Versus'])) {
            ...
            if ($model->save())
                $this->redirect(array('view', 'id' => $model->versus_id));
        }
    ...
    public function actionIndex() {
        $dataProvider = new CActiveDataProvider('Versus');
